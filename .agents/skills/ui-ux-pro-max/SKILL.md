...
> **Offline / Quick Reference**: For complete accessibility checklists, interaction rules, contrast standards, and responsive guidelines, see [Quick Reference](./references/quick-reference.md) and [Pro Rules](./references/pro-rules.md).
# Prerequisites
